...
import { adaptAuthMiddleware, adaptRoute } from '../adapters/express-adapter'
...
export default (app: Express): void => {
    ...
    router.get('/company', adaptAuthMiddleware(makeAuthMiddleware()), adaptRoute(makeListCompanies()))
